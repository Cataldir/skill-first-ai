...
- **Event**: AI Tech Circle.
- **Date**: 28 May 2026.
- **Audience**: Senior Brazilian leaders (C-level, Heads, Directors).
...
The editable PowerPoint deck is generated locally by `build_pptx.py`
using `python-pptx`. Every slide is composed of native text boxes,
so PowerPoint can edit titles, bullets, and code blocks directly. The
generated `.pptx` is not committed, so the public repository carries only
